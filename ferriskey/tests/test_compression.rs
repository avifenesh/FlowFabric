...
use ferriskey::compression::*;
use ferriskey::request_type::RequestType;
use std::str::FromStr;
...
mod compression_tests {
    ...
    fn test_descriptive_errors() {
        use ferriskey::compression::lz4_backend::Lz4Backend;
        use ferriskey::compression::zstd_backend::ZstdBackend;
